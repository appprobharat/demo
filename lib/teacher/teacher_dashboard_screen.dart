...
import 'package:demo_app/teacher/student_list.dart';
import 'package:demo_app/teacher/teacher_recent_homework.dart';
import 'package:demo_app/teacher/teacher_sidebar_menu.dart';
              ...
              itemBuilder: (context) {
                return sessionList.map((session) {
                  return PopupMenuItem<String>(
                    value: session,
                    child: Text(session, style: const TextStyle(fontSize: 14)),
                  );
                }).toList();
              },

import 'dart:convert';
import 'package:demo_app/admin/AllDue/alldue.dart';
import 'package:demo_app/admin/alert/alert.dart';
import 'package:demo_app/admin/bar_garph.dart';
import 'package:demo_app/admin/birthday.dart';
import 'package:demo_app/admin/profile/fees.dart';
import 'package:flutter/material.dart';
import 'package:shared_preferences/shared_preferences.dart';
import 'package:demo_app/admin/Attendance/emp_attendance.dart';
import 'package:demo_app/admin/Receipt/list_receipt.dart';
import 'package:demo_app/admin/admin_sidebar.dart';
import 'package:demo_app/admin/admissions/admission_list.dart';
import 'package:demo_app/admin/admissions/quick_admission.dart';
import 'package:demo_app/admin/profile/admin_profile.dart';
import 'package:demo_app/admin/complaint/list_complaint.dart';
import 'package:demo_app/admin/day%20book/day_book.dart';
import 'package:demo_app/admin/employee/list_employee.dart';
import 'package:demo_app/admin/enquiry/list_enquiry.dart';
import 'package:demo_app/admin/fees/fee_due.dart';
import 'package:demo_app/admin/income/list_income.dart';
import 'package:demo_app/admin/ledger/stu_ledger.dart';
import 'package:demo_app/admin/ledger/teacher_ledger.dart';
import 'package:demo_app/admin/payment/list_payment.dart';
import 'package:demo_app/admin/result/stu_result.dart';
import 'package:demo_app/admin/Attendance/stu_attendance.dart';
